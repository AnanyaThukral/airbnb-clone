...
const Header = ({placeholder}) => {
    ...
    const handleSelect = (ranges) => {
        ...
        setEndDate(ranges.selection.endDate) //coming from the library
    }
        ...
        <header className='sticky top-0 z-50 grid grid-cols-3 bg-white shadow-md py-5 px-5 md:px-10'>
            ...
            <div className='flex items-center md:border-2 rounded-full py-2 md:shadow-sm'>
                <input value={searchInput}
                       ...
                       className = "pl-5 bg-transparent outline-none flex-grow text-sm text-gray-600 placeholder-gray-400" type="text" placeholder= {placeholder || "Start your search"}></input>
                <SearchIcon className = "hidden md:inline-flex h-8 md:m/_next/imagex-2 bg-red-300 text-white rounded-full p-2 cursor-pointer"/>
            </div>
            {/* right */}
            ...
            <div className='flex flex-col col-span-3 mx-auto'>
                ...
                <div className='flex items-center border-b mb-4'>
                    ...
                    <input value= {noOfGuests} type='number' min={1} className='w-12 pl-2 text-lg outline-none text-red-400' onChange={e=>{
